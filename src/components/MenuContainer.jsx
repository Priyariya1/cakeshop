...
const MenuContainer = () => {
  const [filter, setFilter] = useState("Butter Cake");
          ...
          {categories &&
            categories.map((category) => (
              <motion.div
                ...
                } w-24 min-w-[94px] h-28 cursor-pointer rounded-lg drop-shadow-xl flex flex-col gap-3 items-center justify-center hover:bg-blue-400 `}
