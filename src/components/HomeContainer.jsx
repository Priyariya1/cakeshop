  ...
  return (
    ...
    >
      <div className="flex flex-col items-start justify-center flex-1 gap-6 py-2">
        <div className="flex items-center justify-center gap-2 px-4 py-1 rounded-full bg-rose-100">
        ...
        We have finest selection of premium cakes just for to create a memorable moment with your loved ones. 
        Order cakes online with our online cake shop Coimbatore and send it to your friends, 
        family and loved ones for their birthday, anniversary, celebrations, festivals, parties and more!
        </p>

        <button
          type="button"
          className="w-full px-4 py-2 transition-all duration-100 ease-in-out rounded-lg bg-gradient-to-br from-rose-400 to-rose-500 md:w-auto hover:shadow-lg"
        >
          Order Now
        </button>
      </div>
