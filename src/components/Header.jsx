...
const Header = () => {
  ...
  return (
    <header className="fixed z-50 w-screen p-3 px-4 text-white bg-blue-400 shadow-xl md:p-6 md:px-16 ">
      {/* desktop & tablet */}
      <div className="items-center justify-between hidden w-full h-full md:flex">
        <Link to={"/"} className="flex items-center gap-2">
          ...
          <p className="text-xl font-bold text-white">Cake shop</p>
        </Link>
        ...
        <div className="flex items-center gap-8">
          ...
          <div
            ...
            onClick={showCart}
          >
            <MdShoppingBasket className="text-2xl text-white cursor-pointer" />
